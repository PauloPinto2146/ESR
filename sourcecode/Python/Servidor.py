...
class Servidor:	
	...
	def main(self):
		try:
			...
			print("Using provided video file 1 ->  " + files[0])
			print("Using provided video file 2 ->  " + files[1])
		except:
			print("[Usage: Servidor.py <videofile>]\n")
			files[0] = "movie.Mjpeg"
			print("Using default video file ->  " + files[0])

		# videoStream
		self.clientInfo['videoStream'] = VideoStream(files[0])
		# socket
